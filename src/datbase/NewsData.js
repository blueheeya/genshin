    const NewsList = [
        {  
            class : "전체",
            title : "EP - 모든 것을 씻어내리는 비",
            data : "2024.04.05",
            image: "news_thmimg_1.jpg",
            bodyimg: "news_bodyimg_1.gif",
        ...
        {  
            ...
            data : "2024.04.05",
            image: "news_thmimg_2.jpg",
            bodyimg: "news_bodyimg_2.gif",
            body : "「하아… 역시나 필요한 자금을 잘못 계산했군. 지금 가진 자금으로는 프로젝트를 실행할 수 없겠어. 그래도 일찍 접으면 재기할 기회가 있겠지. 일단 이거라도 받아 줘. 앞으로도 많은 응원 부탁해!」[원석x40] 보상 수령하기: https://hoyo.link/chAiFKAL* 보상 수령 기간은 2024년 4월 4일 00:59(한국시간)까지입니다. 잊지 말고 웹페이지에서 보상을 수령해 주세요!웹페이지에서 보상을 수령하면 게임 내 우편으로 보상이 전달됩니다. 우편의 유효 기간은 30일이니 잊지 말고 수령해 주세요"
        },
    ]
            ...
            <>
                {NewsList.map((item,i)=>{
                    ...
                    <div className="listWrap">
                        <div className="imgWrap"><img src={`${process.env.PUBLIC_URL}/images/news/${NewsList[i].image}`} alt="" /></div>
                        <ul>
                            <li className="text_tt">{NewsList[i].title}</li>
                            <li className="text_date">{NewsList[i].data}</li>
                            <li>{NewsList[i].body}</li>
                        </ul>
                    </div>
                    )
                })}
